...
# pod repo add SWUtils https://github.com/mhtranbn/SWUtils.git
# pod repo push SWUtils SWUtils.podspec --allow-warnings
# pod lib lint --allow-warnings
# pod repo update
# pod trunk register hoangtm@runsystem.net 'hoangtm' --description='macbook pro'
# pod trunk push SWUtils.podspec --allow-warnings --verbose